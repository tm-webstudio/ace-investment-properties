...
export const sampleProperties: Property[] = [
  ...
  {
    id: "12",
    title: "Regent Street, Mayfair, W1",
    price: 5200,
    address: "123 Regent Street, W1B 4TB",
    city: "London",
    state: "Greater London",
    bedrooms: 2,
    bathrooms: 2,
    propertyType: "2BR",
    description:
      "Prestigious apartment on world-famous Regent Street with luxury finishes and prime shopping location. Features marble bathrooms and designer kitchen.",
    amenities: ["Luxury finishes", "Prime shopping", "Marble bathrooms", "Designer kitchen"],
    images: ["/luxury-high-rise-living-room.png", "/luxury-apartment-bedroom.png", "/high-rise-balcony-view.png"],
    availableDate: "2025-12-01",
    landlordId: "landlord1",
    landlordName: "James Thompson",
  ...
  {
    id: "13",
    title: "Tower Bridge Road, Bermondsey, SE1",
    price: 2400,
    address: "67 Tower Bridge Road, SE1 2UP",
    city: "London",
    state: "Greater London",
    bedrooms: 1,
    bathrooms: 1,
    propertyType: "1BR",
    description:
      "Modern apartment with iconic Tower Bridge views and riverside location. Walking distance to London Bridge and excellent transport connections.",
    amenities: ["Tower Bridge views", "Riverside location", "Modern fixtures", "Transport links"],
    images: ["/modern-downtown-loft.png", "/modern-loft-kitchen.png", "/loft-bedroom-city-view.png"],
  ...
  {
    id: "14",
    title: "Old Street, Shoreditch, EC1",
    price: 1800,
    ...
    propertyType: "Studio",
    description:
      "Industrial-style studio in trendy Shoreditch with exposed brick walls and tech hub location. Perfect for young professionals and startups.",
    amenities: ["Exposed brick", "Tech hub", "Industrial style", "Young professional area"],
    images: ["/cozy-studio-apartment.png", "/studio-kitchenette.png", "/studio-bathroom.png"],
  ...
  {
    id: "15",
    title: "Hampstead Heath, Hampstead, NW3",
    price: 3800,
    address: "12 Heath Road, NW3 2RU",
    city: "London",
    state: "Greater London",
    bedrooms: 3,
    bathrooms: 2,
    propertyType: "3BR+",
    description:
      "Elegant Georgian house overlooking Hampstead Heath with period features and private garden. Quiet residential area with village atmosphere.",
    amenities: ["Heath views", "Period features", "Private garden", "Village atmosphere"],
    images: ["/spacious-family-home.png", "/cozy-family-living-room.png", "/family-home-kitchen.png"],
    availableDate: "2025-11-15",
    landlordId: "landlord1",
    landlordName: "James Thompson",
