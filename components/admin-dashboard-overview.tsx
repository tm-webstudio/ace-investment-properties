...
import { Settings, Eye, CheckCircle, XCircle, Clock, Calendar, Home, Users, BarChart3, Plus, Shield, Building, FileText, Download, ExternalLink, ChevronLeft, ChevronRight, Check, Mail, Phone, Loader2 } from "lucide-react"
...
export function AdminDashboardOverview({ admin, onTabChange }: AdminDashboardOverviewProps) {
  ...
  const openLandlordModal = async (property: any) => {
    ...
    <div className="space-y-8">
      ...
      <Card className="mb-5 sm:mb-8">
        <CardHeader className="flex flex-row items-center justify-between">
          <CardTitle className="text-[15px] sm:text-base">Pending Property Approvals</CardTitle>
          <Button
            variant="outline"
            size="sm"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="max-h-[600px] overflow-hidden flex flex-col">
          <CardHeader className="flex flex-row items-center justify-between">
            <CardTitle className="text-[15px] sm:text-base">Landlord Documents</CardTitle>
            <Button
              variant="outline"
              size="sm"
              className="bg-transparent"
