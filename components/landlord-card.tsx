...
export function LandlordCard({ name, phone, email }: LandlordCardProps) {
  const initials = name
    .split(" ")
    .map((n) => n[0])
    .join("")
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-center text-sm text-muted-foreground">
            ...
            <span>q@aceinvestmentproperties.com</span>
          </div>
        </div>
        ...
        <div className="space-y-2">
          ...
          <Button
            ...
            onClick={() => window.open('https://wa.me/447480485707', '_blank')}
          >
